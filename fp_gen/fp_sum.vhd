-- -------------------------------------------------------------
-- 
-- File Name: D:\Dan\FPGA_FPU\fp_gen\fp_sum.vhd
...
BEGIN
  ...
  Add1_out1 <= Add1_sub_temp(7 DOWNTO 0);
  ...
  Add5_out1 <= unsigned(Add5_sub_temp(24 DOWNTO 0));

  Add2_out1 <= resize(resize(Data_Type_Conversion1_out1, 32) + resize(Data_Type_Conversion2_out1, 32), 25);
  ...
  Add3_out1 <= unsigned(Add3_sub_temp(7 DOWNTO 0));
