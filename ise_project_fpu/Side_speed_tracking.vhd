-- -------------------------------------------------------------
-- 
-- File Name: D:\Dan\FPGA_Test\ise_project_1\Side_speed_tracking.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Side_speed_tracking
-- Source Path: ss_controller/Side speed tracking
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Side_speed_tracking;


ARCHITECTURE rtl OF Side_speed_tracking IS

  -- Component Declarations
  COMPONENT MAC_instruction_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : MAC_instruction_block2
    USE ENTITY work.MAC_instruction_block2(rtl);
...
BEGIN
  ...
  u_MAC_instruction : MAC_instruction_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
