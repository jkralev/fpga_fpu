-- -------------------------------------------------------------
-- 
-- File Name: D:\Dan\FPGA_FPU\ise_project_fpu\contr1_pkg.vhd
...
PACKAGE contr1_pkg IS
  ...
  TYPE T_state_type_is_Handle_command IS (IN_Receive, IN_Wait, IN_Wait2, IN_Wait3, IN_Wait4, IN_Wait8, IN_Wait9);
END contr1_pkg;
