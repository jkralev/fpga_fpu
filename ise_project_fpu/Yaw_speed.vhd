-- -------------------------------------------------------------
-- 
-- File Name: D:\Dan\FPGA_Test\ise_project_1\Yaw_speed.vhd
...
-- 
-- Module: Yaw_speed
-- Source Path: ss_controller/Yaw speed
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Yaw_speed IS

  -- Component Declarations
  COMPONENT MAC_instruction_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : MAC_instruction_block4
    USE ENTITY work.MAC_instruction_block4(rtl);
...
BEGIN
  ...
  u_MAC_instruction : MAC_instruction_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  Parameters_out1(0) <= to_signed(2097152, 32);
  Parameters_out1(1) <= to_signed(-1048576, 32);
  Parameters_out1(2) <= to_signed(-157286, 32);
  Parameters_out1(3) <= to_signed(309854, 32);
  Parameters_out1(4) <= to_signed(-152599, 32);
